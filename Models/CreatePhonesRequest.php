...
class CreatePhonesRequest implements JsonSerializable
{
     ...
     * @maps home_phone
     * @var \PlugHacker\PlugAPILib\Models\CreatePhoneRequest|null $homePhone public property
     */
    public $homePhone;
     ...
     * @todo Write general description for this property
     * @maps mobile_phone
     * @var \PlugHacker\PlugAPILib\Models\CreatePhoneRequest|null $mobilePhone public property
     */
    public $mobilePhone;
