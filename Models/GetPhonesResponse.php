...
class GetPhonesResponse implements JsonSerializable
{
     ...
     * @required
     * @maps home_phone
     * @var \PlugHacker\PlugAPILib\Models\GetPhoneResponse $homePhone public property
     */
    public $homePhone;
     ...
     * @required
     * @maps mobile_phone
     * @var \PlugHacker\PlugAPILib\Models\GetPhoneResponse $mobilePhone public property
     */
    public $mobilePhone;
