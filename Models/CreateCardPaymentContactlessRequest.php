...
class CreateCardPaymentContactlessRequest implements JsonSerializable
{
     ...
     * @maps apple_pay
     * @var \PlugHacker\PlugAPILib\Models\CreateApplePayRequest|null $applePay public property
     */
    public $applePay;
     ...
     * @maps google_pay
     * @var \PlugHacker\PlugAPILib\Models\CreateGooglePayRequest|null $googlePay public property
     */
    public $googlePay;

    /**
     * The Emv encrypted request
     * @var \PlugHacker\PlugAPILib\Models\CreateEmvDecryptRequest|null $emv public property
     */
    public $emv;
