...
class CreateChargeRequest implements JsonSerializable
{
     ...
     * Payment data
     * @required
     * @var \PlugHacker\PlugAPILib\Models\CreatePaymentRequest $payment public property
     */
    public $payment;
     ...
     * @required
     * @var \PlugHacker\PlugAPILib\Models\CreateAntifraudRequest $antifraud public property
     */
    public $antifraud;
