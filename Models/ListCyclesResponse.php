...
class ListCyclesResponse implements JsonSerializable
{
     ...
     * @var \PlugHacker\PlugAPILib\Models\GetPeriodResponse[]|null $data public property
     */
    public $data;

    /**
     * Paging object
     * @var \PlugHacker\PlugAPILib\Models\PagingResponse|null $paging public property
     */
    public $paging;
