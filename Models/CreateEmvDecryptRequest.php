...
class CreateEmvDecryptRequest implements JsonSerializable
{
     ...
     * @todo Write general description for this property
     * @required
     * @var \PlugHacker\PlugAPILib\Models\CreateEmvDataDecryptRequest $data public property
     */
    public $data;

    /**
     * @todo Write general description for this property
     * @var \PlugHacker\PlugAPILib\Models\CreateCardPaymentContactlessPOIRequest|null $poi public property
     */
    public $poi;
