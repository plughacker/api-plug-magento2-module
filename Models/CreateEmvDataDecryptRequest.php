...
class CreateEmvDataDecryptRequest implements JsonSerializable
{
    ...
    /**
     * Dukpt data request
     * @var \PlugHacker\PlugAPILib\Models\CreateEmvDataDukptDecryptRequest|null $dukpt public property
     */
    public $dukpt;
     ...
     * Encrypted tags list
     * @required
     * @var \PlugHacker\PlugAPILib\Models\CreateEmvDataTlvDecryptRequest[] $tags public property
     */
    public $tags;
