...
class GetChargeResponse implements JsonSerializable
{
    ...
    /**
     * @todo Write general description for this property
     * @maps transactionRequests
     * @var \PlugHacker\PlugAPILib\Models\GetTransactionResponse|null $transactionRequests public property
     */
    public $transactionRequests;

    /**
     * @todo Write general description for this property
     * @var \PlugHacker\PlugAPILib\Models\GetInvoiceResponse|null $invoice public property
     */
    public $invoice;

    /**
     * @todo Write general description for this property
     * @var \PlugHacker\PlugAPILib\Models\GetOrderResponse|null $order public property
     */
    public $order;
     ...
     * @param GetTransactionResponse  $transactionRequests Initialization value for $this->transactionRequests
    ...
    public function __construct()
    {
        if (19 == func_num_args()) {
            ...
            $this->transactionRequests = func_get_arg(10);
