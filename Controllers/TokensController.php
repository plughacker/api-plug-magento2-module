...
class TokensController extends BaseController
{
    ...
    public function getToken(
        ...
        $_queryBuilder = '/tokens/{id}?appId={client_id}';
        ...
        return $mapper->mapClass($response->body, 'PlugHacker\\PlugAPILib\\Models\\GetTokenResponse');
    }
    ...
    public function createToken(
        ...
        //prepare query string for API call
        $_queryBuilder = '/tokens?appId={client_id}';
